...
class MainActivity : AppCompatActivity() ,GroceryRVAdapter.GroceryItemClickInterface{
   ...
   lateinit var groceryViewModel: GroceryViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Initialising GroceryRVAdapter and passing our list inside of it
        groceryRVAdapter = GroceryRVAdapter(list,this)
        //Setting LayoutManager
        itemsRV.layoutManager =LinearLayoutManager(this)
        itemsRV.adapter = groceryRVAdapter
        //calling grocery repository inside which we are pasing the database
        val groceryRepository= GroceryRepository(GroceryDatabase(this))
        //creating a variiable for factory where groceryRepository will be passed inside of it
